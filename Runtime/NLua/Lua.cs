...
";
        ...
        void Init(ObjectTranslator translator = null)
        {
            ...
            _translator = translator ?? new ObjectTranslator(this, _luaState);
...
#if __IOS__ || __TVOS__ || __WATCHOS__ || UNITY_ANDROID || UNITY_IOS || UNITY_STANDALONE
